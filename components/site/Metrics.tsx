...
const METRICS = [
  {
    ...
    border: "border-b lg:border-b-0 border-r lg:border-r-0 border-hairline",
  },
  {
    label: "TENANTS",
    value: "0",
    caption: "Accounts a tenant or contractor needs to submit documents",
    border: "border-b lg:border-b-0 border-hairline",
  },
  {
    label: "RECORDS",
    value: "1",
    caption: "Close-out package per project, generated on demand",
    border: "border-r lg:border-r-0 border-hairline",
  },
  {
    label: "MONEY",
    value: "0",
...
export function Metrics() {
  return (
    <section className="bg-band border-y border-hairline">
      <div className="max-w-[120rem] mx-auto px-6 lg:px-10 py-14 lg:py-20">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 divide-x divide-hairline border-t border-b border-hairline">
          {METRICS.map((metric) => (
            <div
              key={metric.label}
            ...
            >
              ...
              <p className="font-heading font-bold text-ink text-4xl lg:text-5xl tracking-[-0.03em] mt-2">
                {metric.value}
              </p>
              <p className="font-body text-ink/60 text-sm mt-2 leading-snug">
                {metric.caption}
              </p>
            </div>
          ))}
