...
export function Founder() {
  ...
  return (
    <section id="founder" className="bg-[#F4F5F6] border-y border-[#E4E6E8]">
        ...
        <div className="grid lg:grid-cols-12 gap-10 lg:gap-16 items-start">
          {photo && (
            <div className="lg:col-span-3">
              <div className="relative aspect-square w-40 lg:w-full overflow-hidden border border-[#1A1C1E]">
                <Image
                  src={`/${PHOTO}`}
          ...
          <div className={photo ? "lg:col-span-7 lg:col-start-5" : "lg:col-span-8"}>
            ...
            <p className="mt-5 font-body text-[#1A1C1E]/70 text-lg leading-[1.6]">
            ...
            <p className="mt-5 font-body text-[#1A1C1E] text-lg leading-[1.6]">
            ...
            <p className="mt-7 font-mono text-[11px] tracking-wider text-[#1A1C1E]/50 uppercase">
